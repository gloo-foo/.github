...
- [ ] I have used the appropriate framework pattern (Map, Filter, Accumulate, Aggregate, Expand, etc.)
- [ ] My command properly supports context cancellation
- [ ] My command uses constant sentinel errors (`errors.Is`-matchable)
- [ ] My command uses strongly-typed, sealed flags (if applicable)
- [ ] `make check` passes (format, lint, complexity ≤ 7, 100% coverage, vuln scan)
