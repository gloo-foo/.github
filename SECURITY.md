...
2. Email security reports to: [security@gloo.foo](mailto:security@gloo.foo)
...
### Security Considerations in gloo.foo
...
- Open a [GitHub Discussion](https://github.com/gloo-foo/framework/discussions)
